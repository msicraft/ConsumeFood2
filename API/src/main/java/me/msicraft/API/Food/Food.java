...
public class Food {
    ...
    public enum Options {
        ...
        POTION_EFFECT(false, "Potion Effect", List.of("Potion effects applied when consumed"), null, "PotionEffect"),
        COMMAND(false, "Command", List.of("Execute commands applied when consumed"), null, "Command"),
